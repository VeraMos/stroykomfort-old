$(function () {
    $('.header__banner').owlCarousel({
        ...
        dots: true,
        smartSpeed: 700,
        navText: ["<img src='/local/img/slider__arrow_prev.png'>", "<img src='/local/img/slider__arrow_next.png'>"],
    });
    ...
    $('.prj__right').owlCarousel({
        ...
        smartSpeed: 700,
        dots: false,
        navText: ["<img src='/local/img/prj-slider__arrow_prev.png'>", "<img src='/local/img/prj-slider__arrow_next.png'>"],
        responsive: {
            0: {
                items: 1,
            },
    ...
    if ($(window).width() > 1200) {
        $('.header__nav-link-wrp').hover(
            function () {
                $(this).toggleClass('hover').find('.header__nav-sub').slideToggle(30);
            },
            function () {
                $(this).toggleClass('hover', false).find('.header__nav-sub').fadeOut(30);
            },
        );
        $('.header__nav-sub-link-wrp').hover(
            function () {
                $(this).toggleClass('hover-2').find('.header__nav-sub_2').slideToggle(30);
            },
            function () {
                $(this).toggleClass('hover-2', false).find('.header__nav-sub_2').fadeOut(30);
            },
        );
    }
    ...
    if ($(window).width() < 1199) {
        ...
        $('.link-no-click').on('click', function (e) {
            e.preventDefault();
